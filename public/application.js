...
var onGetNotes = function onGetNotes() {
  api.getNotes().then(ui.getNotesSuccess).catch(ui.getNotesFailure);
};

var onGetMyNotes = function onGetMyNotes() {
  // event.preventDefault()
  api.getMyNotes().then(ui.getMyNotesSuccess).catch(ui.getMyNotesFailure);
};
...
var onUpdateNote = function onUpdateNote(event) {
  ...
  var data = getFormFields(event.target);
  // console.log(data)
  var noteId = $(event.target).closest('div').attr('data-id');
  // console.log(gameId)
  api.updateNote(data, noteId).then(ui.updateNoteSuccess).then(function () {
    return onGetMyNotes(event);
  }).catch(ui.updateNoteFailure);
};

var createShows = function createShows(event) {
  event.preventDefault();
  $('.user-message').text('');
  $('#createContent').show();
  $('.personal').hide();
...
var onCreateNote = function onCreateNote(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createNote(data).then(ui.createSuccess).then(function () {
    return onGetMyNotes();
  }).catch(ui.createFailure);
};

var onDestroyNote = function onDestroyNote(event) {
  event.preventDefault();
  var noteId = $(event.target).closest('button').attr('data-id');
  api.destroyNote(noteId).then(ui.destroyNoteSuccess).then(function () {
    return onGetMyNotes(event);
...
var getMyNotes = function getMyNotes() {
  return $.ajax({
...
var destroyNote = function destroyNote(noteId) {
  return $.ajax({
    url: config.apiUrl + '/notes/' + noteId,
    method: 'DELETE',
    headers: {
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://tpad.herokuapp.com',
...
var showNotesTemplate = __webpack_require__(15);

var showMyNotesTemplate = __webpack_require__(32);
...
var getNotesSuccess = function getNotesSuccess(data) {
  ...
  $('#createContent').hide();
  $('.public').show();
  var showNotesHtml = showNotesTemplate({
...
var getNotesFailure = function getNotesFailure() {
  $('.message').text('Sorry public notes are not available at the moment');
};

var getMyNotesSuccess = function getMyNotesSuccess(data) {
  // console.log(data.user.notes)
  $('.public').hide();
  $('#createContent').hide();
  $('.personal').show();
  var showNotesHtml = showMyNotesTemplate({
...
var getMyNotesFailure = function getMyNotesFailure() {
...
var destroyNoteSuccess = function destroyNoteSuccess() {
...
var destroyNoteFailure = function destroyNoteFailure() {
...
module.exports = {
  ...
  getNotesFailure: getNotesFailure,
  getMyNotesSuccess: getMyNotesSuccess,
  getMyNotesFailure: getMyNotesFailure,
  updateNoteSuccess: updateNoteSuccess,
  createSuccess: createSuccess,
  createFailure: createFailure,
  updateNoteFailure: updateNoteFailure,
  destroyNoteSuccess: destroyNoteSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return " <!-- Temolate structure of db -->\n  <h3 data-id=\""
    ...
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.note_content : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</p>\n  </div>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.note_content : stack1), depth0))
    + "\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return " <!-- Template structure of db -->\n  <h3 data-id=\""
    ...
    + "\" class=\"modal-body\">\n              <form data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"updating-note-form\">\n                <p>Title: <input required type=\"text\" name=\"note[title]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\"></p>\n                <p>Date: <input required type=\"date\" name=\"note[date]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
    + "\"></p>\n                <textarea required type=\"text\" name=\"note[note_content]\" maxlength=\"1000\" rows=\"4\" cols=\"50\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.note_content : stack1), depth0))
